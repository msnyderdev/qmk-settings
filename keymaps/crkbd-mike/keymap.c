...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
  ...
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LCTRL, KC_LCTRL, KC_LSFT, KC_LALT, KC_LGUI, KC_MINUS,                  KC_MINUS, KC_LEFT, KC_DOWN, KC_UP, KC_RIGHT, KC_EQUAL,
  //|--------+--------+--------+--------+--------+--------|                    |--------+--------+--------+--------+--------+--------|
      KC_LSFT, XXXXXXX, LSFT(KC_LBRC), LSFT(KC_RBRC), KC_LBRC, KC_RCBR,        XXXXXXX,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,   LSFT(KC_INS),
  //|--------+--------+--------+--------+--------+--------+--------|  |--------+--------+--------+--------+vvcvccc--------+--------+--------|
